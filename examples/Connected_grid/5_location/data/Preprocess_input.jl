...
df_loc_path = joinpath(rootn,"data","Location5.csv")
...
clus = FileIO.load(joinpath(rootn,"data","kmeanval5.jld2"),"clus")
ns = FileIO.load(joinpath(rootn,"data","kmeanave5.jld2"),"ns")
w = Dict()
for i = 1:n_tm
    ck = clus[i]
    for j = 1:n_k
